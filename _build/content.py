...
DMG = f"{REPO}/releases/download/v0.1.3/AdPlaybook-0.1.3-arm64.dmg"
...
<p class="hero-sub">v0.1.3 · 22 MB · Apple Silicon · notarised by Apple</p>
<div class="trust">
...
<p class="src">v0.1.3 · <a href="{{RELEASES}}">All releases</a> · needs Outlier
