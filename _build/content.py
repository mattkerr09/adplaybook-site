...
<figure class="adshot reveal">
  <img src="/img/honeybook-a-control-preview.svg" width="460" height="312"
       alt="Google search ad preview for variant A: headline 27 of 30 characters,
            description 1 61 of 90, description 2 54 of 90." loading="lazy">
  <figcaption><span>Variant A from this run.</span> Laid out as a Google search
  ad, with every field counted against Google's published limits and the page
  those limits were read from printed underneath.</figcaption>
</figure>
